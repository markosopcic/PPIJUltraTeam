...
public class AddingDataNeverHaveIEverActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adding_data_never_have_iever);
    ...
    public void onDone(View view) {
        ...
        for(int i=brojUcitanih;i<size;++i){
            ...
            if(tekstKategorija.isEmpty()){
                Toast.makeText(this, "Polje ne može biti prazno", Toast.LENGTH_SHORT).show();
                editTekstKategorija.requestFocus();
                return;
            }
            NeverHaveIEverWords category=new NeverHaveIEverWords(tekstKategorija);
            MainMenuActivity.database.databaseDao().insertNeverHaveIEver(category);
        }
